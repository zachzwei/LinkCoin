...
class PaymentDetails : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_genesis() const;
  inline void clear_genesis();
  static const int kGenesisFieldNumber = 1;
  inline const ::std::string& genesis() const;
  inline void set_genesis(const ::std::string& value);
  inline void set_genesis(const char* value);
  inline void set_genesis(const char* value, size_t size);
  inline ::std::string* mutable_genesis();
  inline ::std::string* release_genesis();
  inline void set_allocated_genesis(::std::string* genesis);
 ...
 private:
  inline void set_has_genesis();
  inline void clear_has_genesis();
  ...
  ::google::protobuf::uint32 _has_bits_[1];
  mutable int _cached_size_;
  static ::std::string* _default_genesis_;
  ::std::string* genesis_;
...
// optional string genesis = 1 [default = "1a91e3dace36e2be3bf030a65679fe821aa1d6ef92e7c9902eb318182c355691"];
inline bool PaymentDetails::has_genesis() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void PaymentDetails::set_has_genesis() {
  _has_bits_[0] |= 0x00000001u;
}
inline void PaymentDetails::clear_has_genesis() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void PaymentDetails::clear_genesis() {
  if (genesis_ != _default_genesis_) {
    genesis_->assign(*_default_genesis_);
  }
  clear_has_genesis();
}
inline const ::std::string& PaymentDetails::genesis() const {
  // @@protoc_insertion_point(field_get:payments.PaymentDetails.genesis)
  return *genesis_;
}
inline void PaymentDetails::set_genesis(const ::std::string& value) {
  set_has_genesis();
  if (genesis_ == _default_genesis_) {
    genesis_ = new ::std::string;
  }
  genesis_->assign(value);
  // @@protoc_insertion_point(field_set:payments.PaymentDetails.genesis)
}
inline void PaymentDetails::set_genesis(const char* value) {
  set_has_genesis();
  if (genesis_ == _default_genesis_) {
    genesis_ = new ::std::string;
  }
  genesis_->assign(value);
  // @@protoc_insertion_point(field_set_char:payments.PaymentDetails.genesis)
}
inline void PaymentDetails::set_genesis(const char* value, size_t size) {
  set_has_genesis();
  if (genesis_ == _default_genesis_) {
    genesis_ = new ::std::string;
  }
  genesis_->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:payments.PaymentDetails.genesis)
}
inline ::std::string* PaymentDetails::mutable_genesis() {
  set_has_genesis();
  if (genesis_ == _default_genesis_) {
    genesis_ = new ::std::string(*_default_genesis_);
  }
  // @@protoc_insertion_point(field_mutable:payments.PaymentDetails.genesis)
  return genesis_;
}
inline ::std::string* PaymentDetails::release_genesis() {
  clear_has_genesis();
  if (genesis_ == _default_genesis_) {
    return NULL;
  } else {
    ::std::string* temp = genesis_;
    genesis_ = const_cast< ::std::string*>(_default_genesis_);
    return temp;
  }
}
inline void PaymentDetails::set_allocated_genesis(::std::string* genesis) {
  if (genesis_ != _default_genesis_) {
    delete genesis_;
  }
  if (genesis) {
  ...
  // @@protoc_insertion_point(field_set_allocated:payments.PaymentDetails.genesis)
}
