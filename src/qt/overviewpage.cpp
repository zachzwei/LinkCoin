...
void OverviewPage::UpdateTip()
{
    QStringList tips = {
        ...
        tr("To see ongoing development and contribute, check out the LinkCoin Core repository on GitHub"),
        tr("Services that claim to double your linkcoin are always ponzi schemes")
    };
