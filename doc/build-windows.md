...
example /usr/src/linkcoin, AND not under, for example, /mnt/d/linkcoin. 
...
way. This will install to `c:\workspace\linkcoin`, for example:

    make install DESTDIR=/mnt/c/workspace/linkcoin
