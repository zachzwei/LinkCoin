...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/linkcoin-community/linkcoin>";
    const std::string URL_WEBSITE = "<https://github.com/linkcoin-community/linkcoin>";
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    // linkcoin: Do we need to do any RPC mining init here?
