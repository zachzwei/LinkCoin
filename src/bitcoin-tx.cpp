...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s linkcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  linkcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded linkcoin transaction") + "\n" +
              "  linkcoin-tx [options] -create [commands]   " + _("Create hex-encoded linkcoin transaction") + "\n" +
              "\n";
