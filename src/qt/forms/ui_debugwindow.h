...
public:
    ...
    QLabel *peerlistHeading;
    QTableView *peerWidget;
    QHBoxLayout *horizontalLayout_6;
    QPushButton *peerAdd;
    QPushButton *peerRemove;
    QPushButton *peerTest;
    QLabel *banHeading;
    ...
    void setupUi(QWidget *RPCConsole)
    {
        ...
        peerlistHeading = new QLabel(tab_peers);
        peerlistHeading->setObjectName(QStringLiteral("peerlistHeading"));
        peerlistHeading->setMinimumSize(QSize(300, 32));
        peerlistHeading->setMaximumSize(QSize(16777215, 32));
        QFont font1;
        font1.setPointSize(12);
        peerlistHeading->setFont(font1);
        peerlistHeading->setCursor(QCursor(Qt::IBeamCursor));

        verticalLayout_101->addWidget(peerlistHeading);
        ...
        peerAdd = new QPushButton(tab_peers);
        peerAdd->setObjectName(QStringLiteral("peerAdd"));
        peerAdd->setCursor(QCursor(Qt::PointingHandCursor));

        horizontalLayout_6->addWidget(peerAdd);

        peerRemove = new QPushButton(tab_peers);
        peerRemove->setObjectName(QStringLiteral("peerRemove"));
        peerRemove->setCursor(QCursor(Qt::PointingHandCursor));

        horizontalLayout_6->addWidget(peerRemove);

        peerTest = new QPushButton(tab_peers);
        peerTest->setObjectName(QStringLiteral("peerTest"));
        peerTest->setCursor(QCursor(Qt::PointingHandCursor));

        horizontalLayout_6->addWidget(peerTest);
    ...
    void retranslateUi(QWidget *RPCConsole)
    {
        ...
        peerlistHeading->setText(QApplication::translate("RPCConsole", "Connected peers", Q_NULLPTR));
        peerAdd->setText(QApplication::translate("RPCConsole", "Add new peer", Q_NULLPTR));
        peerRemove->setText(QApplication::translate("RPCConsole", "Remove peer", Q_NULLPTR));
        peerTest->setText(QApplication::translate("RPCConsole", "One try peer", Q_NULLPTR));
