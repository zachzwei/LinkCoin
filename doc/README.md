...
* Discuss on [#linkcoin-dev](http://webchat.freenode.net/?channels=linkcoin-dev) on Freenode. If you don't have an IRC client use [webchat here](http://webchat.freenode.net/?channels=linkcoin-dev).
