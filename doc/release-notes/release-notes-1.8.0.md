...
use "linkcoind" you must run it the first time with the "-reindex" command line
option.
...
assigned numbers. DIP standards can be found at https://github.com/linkcoin/dips/ .
...
A problem in parsing mangled linkcoin: URIs under Windows has been resolved, and as
part of this work network detection for linkcoin: URIs is now more robust.
