 ...
 *
 *  linkcoin:    Increment mempool limits and accept RBF in steps of 0.0001 DOGE
...
/**
 * linkcoin: Default dust limit that is evaluated when considering whether a
...
/**
 * linkcoin: Default hard dust limit that is evaluated when considering whether
