# Contributing to LinkCoin Core

LinkCoin Core is open source software, and we would welcome contributions
which improve the state of the software. For those wanting to discuss changes,
or look for work that needs doing, please see:

* [Help requests](https://github.com/linkcoin/linkcoin/labels/help%20wanted)
* [Projects](https://github.com/linkcoin/linkcoin/projects)
* [linkcoindev on reddit](https://www.reddit.com/r/linkcoindev/)

## Branch Strategy

LinkCoin Core's default branch is intentionally a stable release, so that anyone
...
LinkCoin Core is a direct fork of Bitcoin Core and therefore benefits from as
