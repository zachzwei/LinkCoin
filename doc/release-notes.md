LinkCoin Core version 1.14.6 is now available from:

  <https://github.com/linkcoin/linkcoin/releases/tag/v1.14.6/>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/linkcoin/linkcoin/issues>

To receive notifications about updates, subscribe to the release mailing list:

  <https://sourceforge.net/projects/linkcoin/lists/linkcoin-releases>

Releases are also announced on reddit:

  <https://www.reddit.com/r/linkcoindev/>
...
```
linkcoin-cli addnode <address> remove
```
...
```
linkcoin-cli liststucktransactions
```
...
```
linkcoin-cli setmaxconnections <desired_amount>
```
...
```
linkcoin-cli rescan <start_block>
```
