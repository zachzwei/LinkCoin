...
/*
 * linkcoin: Scaled to 1/10th of the recommended transaction fee to make RBF
...
/*
 * linkcoin: Creating change outputs at exactly the dustlimit is counter-
...
public:
    ...
    /**
     * LinkCoin: Get a fee targetting a specific transaction speed.
     */
