...
void SendCoinsDialog::updateFeeSectionControls()
{
    ...
    // linkcoin: We don't use smart fees in the UI, so don't need to warn they're not available
...
void SendCoinsDialog::updateGlobalFeeVariables()
{
    if (ui->radioSmartFee->isChecked())
    {
        ...
        // linkcoin: We manually set height well past the last hard fork here
...
void SendCoinsDialog::updateFeeLabel()
{
    ...
    else
    {
        ...
        // linkcoin: We don't use smart fees, so we don't have the data to estimate when it will get in
        ui->labelFeeEstimation->setText("");
