    ...
    platformStyle(_platformStyle)
{
    ...
    // linkcoin: load fallback font in case Comic Sans is not available on the system
    ...
    // linkcoin: Specify Comic Sans as new font.
    QFont newFont("Comic Sans MS", 10);

    // linkcoin: Set new application font
...
void BitcoinGUI::createActions()
{
    ...
    openAction->setStatusTip(tr("Open a linkcoin: URI or payment request"));

    importPrivateKeyAction = new QAction(platformStyle->TextColorIcon(":/icons/address-book"), tr("&Import Private Key..."), this);
    importPrivateKeyAction->setStatusTip(tr("Import a LinkCoin private key"));

    showHelpMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible LinkCoin command-line options").arg(tr(PACKAGE_NAME)));
